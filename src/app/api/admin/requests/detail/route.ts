...
export const PUT = requireRole(['super_admin', 'agent_manager'])(
  async (req: NextRequest) => {
    try {
      ...
      // Validate that assignedToId exists if provided
      if (assignedToId) {
      ...
      // Always update assignedToId - set to null if not provided (unassigned)
