...
import { Building2, BarChart3, Settings, Filter, Plus } from 'lucide-react';
          ...
          {showMobileFilters && (
            <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Due Date Start</label>
                  <Input
                    type="date"
                    value={filters.dueDateStart}
                    onChange={e => setFilters({ ...filters, dueDateStart: e.target.value })}
                    className="border border-gray-300 bg-white text-sm"
                  />
                </div>

                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Due Date End</label>
                  <Input
                    type="date"
                    value={filters.dueDateEnd}
                    onChange={e => setFilters({ ...filters, dueDateEnd: e.target.value })}
                ...
                <Table className="min-w-full">
                  <TableHeader>
                    <TableRow className="bg-[#087055] hover:bg-[#087055] border-0">
                      <TableHead className="text-white font-medium py-4 px-6 text-left border-0 whitespace-nowrap">
                        Insured
                      </TableHead>
                      <TableHead className="text-white font-medium py-4 px-6 text-left border-0 whitespace-nowrap">
                        Serv Que ID
                      </TableHead>
                      <TableHead className="text-white font-medium py-4 px-6 text-center border-0 whitespace-nowrap">
                        Status
                      </TableHead>
                      <TableHead className="text-white font-medium py-4 px-6 text-left border-0 whitespace-nowrap">
                      ...
                      currentRequests.map((request, index) => (
                        ...
                        >
                          <TableCell className="py-4 px-6 border-0">
                            <div className="font-medium text-gray-900">{request.insured}</div>
                          </TableCell>
                          <TableCell className="py-4 px-6 border-0">
