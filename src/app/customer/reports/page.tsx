...
const getNavigation = (userRole: string) => [
  ...
  ...(userRole === 'customer_admin'
    ...
    : []),
  { name: 'Reports', href: '/customer/reports', icon: BarChart3, current: true },
  ...(userRole === 'customer_admin'
...
const fetchReportData = async (filters: {
  ...
  const response = await fetch(`/api/customer/report?${params.toString()}`);
  if (!response.ok) {
...
export default function CustomerReportsPage() {
  ...
  const {
    ...
    queryKey: ['customerReports', selectedStatus, selectedDate, timeRange, startDate, endDate, isCustomRange],
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          {loading || !reportData ? (
            ...
            <Card className="shadow-sm border-0 bg-whte">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                ...
                {lineChartData.length > 0 ? (
                  ...
                  <div className="flex items-center justify-center h-full text-gray-500">
                    <div className="text-center">
                      ...
                      <p className="text-sm">Chart will display when tasks are created</p>
                    </div>
                  </div>
                )}
              </div>
